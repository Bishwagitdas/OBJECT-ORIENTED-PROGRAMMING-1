...
{
	JLabel title, userLabel, passLabel, background;
	JTextField userTF;
	...
	public LoginFrame()
	{
		super("Restaurant Management System - Login Page");
		...
		/*ImageIcon background_image = new ImageIcon("premiumforrestaurants_0.jpg");
		background = new JLabel(background_image);
		background.setBounds(450,150,200,112);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(command.equals(loginBtn.getText()))
		{
			...
			UserEntity user = ur.getUser(userTF.getText(), passPF.getText());
